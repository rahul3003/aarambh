import { r as e, t } from "./rolldown-runtime.C4p97ucE.mjs";
import {
  A as n,
  C as r,
  D as i,
...
function Ie(e, t, n, r, i) {
  let a,
    o,
    s = 0;
  do ((o = t + (n - t) / 2), (a = Us(o, r, i) - e), a > 0 ? (n = o) : (t = o));
  while (Math.abs(a) > Ws && ++s < Gs);
  return o;
}
function Le(e, t, n, r) {
  if (e === t && n === r) return I;
  let i = (t) => Ie(t, 0, 1, e, n);
  return (e) => (e === 0 || e === 1 ? e : Us(i(e), t, r));
}
function Re(e, t) {
  return ic(e) ? e[Hs(0, e.length, t)] : e;
}
function ze(e, t) {
  let n = new Set(),
    r = new Set(),
...
function Be(e, t) {
  let n = !1,
    ...
    a = () => (n = !0),
    o = lc.reduce((e, n) => ((e[n] = ze(a, t ? n : void 0)), e), {}),
    {
      setup: s,
      read: c,
      resolveKeyframes: l,
    ...
    h = () => {
      ...
      ((n = !1),
        a || (i.delta = r ? 1e3 / 60 : Math.max(Math.min(o - i.timestamp, uc), 1)),
        (i.timestamp = o),
        (i.isProcessing = !0),
        s.process(i),
        c.process(i),
  ...
  return {
    schedule: lc.reduce((e, t) => {
      let r = o[t];
      return ((e[t] = (e, t = !1, i = !1) => (n || g(), r.schedule(e, t, i))), e);
    }, {}),
    cancel: (e) => {
      for (let t = 0; t < lc.length; t++) o[lc[t]].cancel(e);
    },
    state: i,
    steps: o,
  };
...
function Ge(e) {
  return (
    isNaN(e) && typeof e == `string` && (e.match(Cc)?.length || 0) + (e.match(Lc)?.length || 0) > 0
  );
}
function Ke(e) {
  let t = e.toString(),
  ...
  return {
    ...
    split: t
      .replace(
        ...
        (e) => (
          K.test(e)
            ? (r.color.push(a), i.push(zc), n.push(K.parse(e)))
            : e.startsWith(Vc)
...
function Je({ split: e, types: t }) {
  ...
  return (r) => {
    ...
    for (let a = 0; a < n; a++)
      if (((i += e[a]), r[a] !== void 0)) {
        let e = t[a];
        e === Rc ? (i += Sc(r[a])) : e === zc ? (i += K.transform(r[a])) : (i += r[a]);
      }
    return i;
  };
}
...
function Xe(e) {
  let t = Ke(e);
  return Je(t)(t.values.map((e, n) => Gc(e, t.split[n])));
}
function Ze(e, t, n) {
  return (
    n < 0 && (n += 1),
...
function ct(e) {
  let t = 0,
    n = e.next(t);
  for (; !n.done && t < $c; ) ((t += 50), (n = e.next(t)));
  return t >= $c ? 1 / 0 : t;
}
...
function ft({
  ...
  let i, a;
  Fs(e <= L(Y.maxDuration), `Spring duration must be 10 seconds or less`, `spring-duration-limit`);
  let o = 1 - t;
...
function ht(e = Y.visualDuration, t = Y.bounce) {
  ...
  let ee = {
    ...
    toString: () => {
      let e = Math.min(ct(ee), $c),
        t = Qc((t) => ee.next(e * t).value, e, 30);
      return e + `ms ` + t;
    },
    toTransition: () => {},
  };
...
function Et(e) {
  typeof e.type == `string` && (e.type = sl[e.type]);
}
function Dt(e) {
  return new ul(e);
}
...
function zt(
  ...
  c && (u.offset = c);
  let d = Rt(s, i);
  (Array.isArray(d) && (u.easing = d), z.value && pc.waapi++);
  let f = {
    delay: r,
    duration: i,
...
function mn(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in s) {
    ...
    if (c.MotionHandoffAnimation) {
      let n = fn(e);
      if (n) {
        let e = c.MotionHandoffAnimation(n, t, B);
        e !== null && ((o.startTime = e), (p = !0));
      }
    }
    un(e, t);
    let m = u ?? e.shouldReduceMotion;
    r.start(au(t, r, i, m && ou.has(t) ? { type: !1 } : o, e, p));
    let h = r.animation;
    h && d.push(h);
  }
  if (o) {
...
function yn(e, t) {
  let n = Tu(e);
  return (Eu.has(n) || (n = q), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0);
}
function bn(e) {
  return typeof e == `number` ? e === 0 : e === null ? !0 : e === `none` || e === `0` || Ls(e);
}
function xn(e, t, n) {
  let r = 0,
    i;
  for (; r < e.length && !i; ) {
    let t = e[r];
    (typeof t == `string` && !Du.has(t) && Ke(t).values.length && (i = e[r]), r++);
  }
  ...
  return (
    r.forEach((e) => {
      let n = !1,
        ...
        l = (e) => {
          ((n = !1),
            c.removeEventListener(`pointerup`, l),
            c.removeEventListener(`pointercancel`, l),
            r && ((r = !1), s(e)));
        },
        u = () => {
          ((n = !0),
            c.addEventListener(`pointerup`, l, i),
            c.addEventListener(`pointercancel`, l, i));
        },
        d = (e) => {
  ...
  let [r, i, a] = En(e, n),
    o = (e) => {
      ...
      let a = t(r, e),
        ...
        s = (e) => {
          o(e, r === c || r === document || n.useGlobalTarget || Mu(r, e.target));
        },
        l = (e) => {
          o(e, !1);
        };
      (c.addEventListener(`pointerup`, s, i), c.addEventListener(`pointercancel`, l, i));
    };
  return (
    r.forEach((e) => {
  ...
  return (
    ...
    () => {
      (Wu.delete(e),
        !Wu.size &&
          typeof Gu == `function` &&
          (c.removeEventListener(`resize`, Gu), (Gu = void 0)));
    }
  );
}
function Hn(e, t) {
...
function tr(e) {
  return $n(e.animate) || $u.some((t) => er(e[t]));
}
function nr(e) {
...
function Ar(e, { layout: t, layoutId: n }) {
  return (
    xl.has(e) || e.startsWith(`origin`) || ((t || n !== void 0) && (!!md[e] || e === `opacity`))
  );
}
function jr(e, t, n) {
  let r = e.style,
...
function Ir(e, t, n, r) {
  for (let n in (Dr(e, t, void 0, r), t.attrs)) e.setAttribute(bd.has(n) ? n : dn(n), t.attrs[n]);
}
function Lr(e, t, n) {
  let r = jr(e, t, n);
  for (let n in e)
    if (X(e[n]) || X(t[n])) {
      let t = bl.indexOf(n) === -1 ? n : `attr` + n.charAt(0).toUpperCase() + n.substring(1);
      r[t] = e[n];
    }
  return r;
}
...
function ri(e, t, n, r) {
  (ni(e.x, t, Md, n ? n.x : void 0, r ? r.x : void 0),
    ni(e.y, t, Nd, n ? n.y : void 0, r ? r.y : void 0));
}
function ii(e) {
...
function pi(e, t, n, r, i, a) {
  i
    ? ((e.opacity = J(0, n.opacity ?? 1, Rd(r))), (e.opacityExit = J(t.opacity ?? 1, 0, zd(r))))
...
function xi(e) {
  ...
  if (c.MotionHasOptimisedAnimation(n, `transform`)) {
    ...
    c.MotionCancelOptimisedAnimation(n, `transform`, B, !(t || r));
  }
  let { parent: r } = e;
...
function Si({
  ...
  return class {
    constructor(e = {}, n = t?.()) {
      ((this.id = qd++),
        ...
        (this.updateProjection = () => {
          ((this.projectionUpdateScheduled = !1),
            z.value && (Wd.nodes = Wd.calculatedTargetDeltas = Wd.calculatedProjections = 0),
            this.nodes.forEach(Ti),
            this.nodes.forEach(Pi),
            this.nodes.forEach(Fi),
            this.nodes.forEach(Ei),
            z.addProjectionMetrics && z.addProjectionMetrics(Wd));
        }),
    ...
    willUpdate(e = !0) {
      ...
      if (
        (c.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && xi(this),
    ...
    resolveTargetDelta(e = !1) {
      ...
      (a &&
        ...
        !(!this.relativeTarget && !this.targetDelta) &&
          ...
          z.value && Wd.calculatedTargetDeltas++));
    }
    ...
    calcProjection() {
      ...
      (!this.projectionDelta || !this.prevProjectionDelta
        ...
        z.value && Wd.calculatedProjections++);
    }
    hide() {
      this.isVisible = !1;
    }
        ...
        (this.pendingAnimation = B.update(() => {
          ((Ud.hasAnimatedSinceResize = !0),
            ...
            (this.currentAnimation = gi(this.motionValue, [0, 1e3], {
              ...
              onComplete: () => {
                (pc.layout--, e.onComplete && e.onComplete(), this.completeAnimation());
              },
            })),
...
function Xi({ children: e, isPresent: t, anchorX: n, anchorY: r, root: o, pop: s }) {
  let c = w(),
    l = a(null),
    u = a({ width: 0, height: 0, top: 0, left: 0, right: 0, bottom: 0 }),
    { nonce: f } = d($),
    h = Yi(l, e.props?.ref ?? e?.ref);
  return (
    p(() => {
      let { width: e, height: i, top: a, left: d, right: p, bottom: m } = u.current;
      if (t || s === !1 || !l.current || !e || !i) return;
      let h = n === `left` ? `left: ${d}` : `right: ${p}`,
        g = r === `bottom` ? `bottom: ${m}` : `top: ${a}`;
...
function ca({ children: e, isValidProp: t, ...n }) {
  t && oa(t);
  let r = d($);
  ((n = { ...r, ...n }),
    (n.transition = $t(n.transition, r.transition)),
    (n.isStatic = M(() => n.isStatic)));
  let i = y(
    () => n,
    [JSON.stringify(n.transition), n.transformPagePoint, n.reducedMotion, n.skipAnimations]
  );
  return m($.Provider, { value: i, children: e });
}
...
function fa(e) {
  let { initial: t, animate: n } = da(e, d(hf));
  return y(() => ({ initial: t, animate: n }), [pa(t), pa(n)]);
}
function pa(e) {
...
function va(e, t, n, r) {
  let i = y(() => {
    let n = yf();
    return (Fr(n, t, xd(r), e.transformTemplate, e.style), { ...n.attrs, style: { ...n.style } });
  }, [t]);
  if (e.style) {
    let t = {};
...
function Ca(e, t, n, r, i, o) {
  ...
  let y = g.current,
    b = d(_f);
  y && !y.projection && i && (y.type === `html` || y.type === `svg`) && wa(g.current, n, i, b);
  let x = a(!1);
  p(() => {
  ...
  let S = n[pu],
    C = a(
      !!S && c !== void 0 && !c.MotionHandoffIsComplete?.(S) && c.MotionHasOptimisedAnimation?.(S)
    );
  return (
    Ns(() => {
      ((_.current = !0),
    ...
    v(() => {
      y &&
        ...
        (C.current &&=
          (queueMicrotask(() => {
            c.MotionHandoffMarkAsComplete?.(S);
          }),
          !1)),
...
function Ea(e, { forwardMotionProps: t = !1, type: n } = {}, r, i) {
  ...
  function s(n, s) {
    ...
    if (!f && c !== void 0) {
      Oa(u, r);
      let t = ka(u);
      ((l = t.MeasureLayout), (p.visualElement = Ca(e, h, u, i, t.ProjectionNode, a)));
    }
    return b(hf.Provider, {
      value: p,
      children: [
        l && p.visualElement ? m(l, { visualElement: p.visualElement, ...u }) : null,
        ba(e, n, xa(h, p.visualElement, s), h, f, t, a),
      ],
    });
  }
...
function eo(e) {
  let [t, n] = Qi(),
    r = d(js);
  return m(Vf, { ...e, layoutGroup: r, switchLayoutGroup: d(_f), isPresent: t, safeToRemove: n });
}
function to(e, t, n) {
  let { props: r } = e;
...
function oo(e, t, n, r) {
  ...
  let l = r - c;
  i.velocity = l > np ? 0 : Fe(i.current - s, l);
}
function so(e, t, n) {
...
function xo(e) {
  ...
  for (let [t, n] of gp) if (bo(e, t)) return { rangeStart: `${n} 0%`, rangeEnd: `${n} 100%` };
}
function So(e) {
  let t = { value: 0 };
  return {
...
function ko(e, t) {
  return c === void 0 ? !1 : e ? Pl() && !!xo(t) : Nl();
}
function Ao({ container: e, target: t, ...r } = {}) {
  let i = M(yp);
  ko(t, r.offset) &&
    ((i.scrollXProgress.accelerate = Oo(`x`, r, e, t)),
    (i.scrollYProgress.accelerate = Oo(`y`, r, e, t)));
  let o = a(null),
    s = a(!1),
    c = n(
      () => (
  ...
  return (
    ...
    v(() => {
      if (s.current)
        return (
          P(!bp(e), `Container ref is defined but not hydrated`, `use-scroll-ref`),
          P(!bp(t), `Target ref is defined but not hydrated`, `use-scroll-ref`),
          c()
        );
    }, [c]),
    i
...
function No(e) {
  ((lu.current = []), e());
  let t = Mo(lu.current, e);
  return ((lu.current = void 0), t);
}
function Po(e, t, n, r) {
...
function Lo(e, t = {}) {
  ...
  if (n) return Po(r);
  let i = jo(r());
  return (p(() => Jn(i, e, t), [i, JSON.stringify(t)]), i);
}
function Ro(e, t = {}) {
    ...
    let g = 0,
      _ = (e, n, r, o = 0, s = 0) => {
        ...
        if ((ee > 0 && bt(u, ee), c.length === 1 && c.unshift(null), m)) {
          (P(m < Cp, `Repeat count too high, must be less than 20`, `repeat-count-high`),
            (b = Jo(b, m)));
          let e = [...c],
            t = [...u];
...
function cs(e, t, n, r) {
  let i = [];
  if (ss(e, t)) i.push(gi(e, (Ko(t) && t.default) || t, n && (n.default || n)));
  else {
    if (e == null) return i;
    let a = qo(e, t, r),
      o = a.length;
  ...
  function r(e, r, i) {
    ...
    if (us(e)) {
      ...
      (typeof i == `function` && (o = i),
        (a = ls(e, n === void 0 ? s : { reduceMotion: n, ...s }, t)));
    } else {
      let { onComplete: s, ...c } = i || {};
      (typeof s == `function` && (o = s),
        (a = cs(e, r, n === void 0 ? c : { reduceMotion: n, ...c }, t)));
    }
    let s = new Xl(a);
    return (
      o && s.finished.then(o),
...
function Ss({ children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: i, ...o }, s) {
  let c = M(() => ep[t]),
    l = [],
    u = a(!1),
    d = a(null);
  ...
  let f = {
    ...
    registerItem: (e, t) => {
      ...
      (r === -1 ? l.push({ value: e, layout: t[n] }) : (l[r].layout = t[n]), l.sort(Cs));
    },
    updateOrder: (e, t, n) => {
      if (u.current) return;
      let a = xs(l, e, t, n);
  ...
  return m(c, {
    ...
    ref: p,
    ignoreStrict: !0,
    children: m(jp.Provider, { value: f, children: e }),
  });
}
function Cs(e, t) {
...
function Ds(e, t, n) {
  let r = t.getBoundingClientRect(),
    ...
    a = n === `x` ? Math.min(c.innerWidth, r.right) : Math.min(c.innerHeight, r.bottom),
    o = e - i,
    s = a - e;
  if (o < Np) {
    let e = 1 - o / Np;
...
function Os(e, t, n, r) {
  ...
  let i = Es(e, n);
  if (!i) return;
  let { amount: a, edge: o } = Ds(t - (n === `x` ? c.scrollX : c.scrollY), i, n);
  if (o === null) {
  ...
  if (s !== o) {
    ...
    let e =
      n === `x`
        ? i.scrollWidth - (l ? c.innerWidth : i.clientWidth)
        : i.scrollHeight - (l ? c.innerHeight : i.clientHeight);
    Ip.set(i, e);
  }
  if (a > 0) {
    let e = Ip.get(i);
    if ((n === `x` ? (l ? c.scrollX : i.scrollLeft) : l ? c.scrollY : i.scrollTop) >= e) return;
  }
  n === `x`
    ? l
      ? c.scrollBy({ left: a })
...
function As(
  ...
  let { axis: h, registerItem: g, updateOrder: _, groupRef: v } = u;
  return m(l, {
    drag: h,
    ...s,
    dragSnapToOrigin: !0,
    ...
    onDrag: (e, t) => {
      ...
      (_(n, f[h].get(), r[h]), Os(v.current, a[h], h, r[h]), i && i(e, t));
    },
    onDragEnd: (e, t) => {
      (ws(), a && a(e, t));
    },
...
var js,
  ...
  Bp = t(() => {
    (o(),
      ...
      (Us = (e, t, n) => (((1 - 3 * n + 3 * t) * e + (3 * n - 6 * t)) * e + 3 * t) * e),
      (Ws = 1e-7),
      (Gs = 12),
      (Ks = (e) => (t) => (t <= 0.5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2)),
      (qs = (e) => (t) => 1 - e(1 - t)),
      (Js = Le(0.33, 1.53, 0.69, 0.99)),
      (Ys = qs(Js)),
      (Xs = Ks(Ys)),
      (Zs = (e) => (e >= 1 ? 1 : (e *= 2) < 1 ? 0.5 * Ys(e) : 0.5 * (2 - 2 ** (-10 * (e - 1))))),
      ...
      (cc = (e) => {
        if (ac(e)) {
          ...
          return (P(oc[e] !== void 0, `Invalid easing type '${e}'`, `invalid-easing-type`), oc[e]);
        return e;
      }),
      ...
      (U = {
        ...
        set: (e) => {
          ((fc = e), queueMicrotask(Ve));
        },
      }),
      (pc = { layout: 0, mainThread: 0, waapi: 0 }),
      ...
      (Ac = { test: Tc(`#`), parse: We, transform: kc.transform }),
      (jc = (e) => ({
      ...
      (K = {
        test: (e) => kc.test(e) || Ac.test(e) || Ic.test(e),
        parse: (e) => (kc.test(e) ? kc.parse(e) : Ic.test(e) ? Ic.parse(e) : Ac.parse(e)),
        transform: (e) =>
          typeof e == `string` ? e : e.hasOwnProperty(`red`) ? kc.transform(e) : Ic.transform(e),
        getAnimatableNone: (e) => {
          let t = K.parse(e);
      ...
      (Wc = (e) => (typeof e == `number` ? 0 : K.test(e) ? K.getAnimatableNone(e) : e)),
      (Gc = (e, t) => (typeof e == `number` ? (t?.trim().endsWith(`/`) ? e : 0) : Wc(e))),
      ...
      (Yc = (e, t) => {
        ...
        let i = { ...n };
        return (e) => (
          (i.red = Kc(n.red, r.red, e)),
          (i.green = Kc(n.green, r.green, e)),
          (i.blue = Kc(n.blue, r.blue, e)),
      ...
      (Zc = (e, t) => {
        ...
        return r.indexes.var.length === i.indexes.var.length &&
          ...
          ? (Xc.has(e) && !i.values.length) || (Xc.has(t) && !r.values.length)
            ? tt(e, t)
            : zs(it(ot(r, i), i.values), n)
          : (Fs(
              !0,
      ...
      (sl = { decay: _t, inertia: _t, tween: wt, keyframes: wt, spring: ht }),
      (cl = class {
        constructor() {
          this.updateFinished();
        }
      ...
      (ul = class extends cl {
        ...
        initAnimation() {
          ...
          s !== wt &&
            typeof o[0] != `number` &&
            ((this.mixKeyframes = zs(ll, st(o[0], o[1]))), (o = [0, 100]));
        ...
        play() {
          ...
          let { driver: e = ol, startTime: t } = this.options;
      ...
      (pl = {
        ...
        rotate: fl,
        rotateZ: fl,
        skewX: (e) => dl(Math.atan(e[1])),
        skewY: (e) => dl(Math.atan(e[2])),
        skew: (e) => (Math.abs(e[1]) + Math.abs(e[2])) / 2,
      }),
      (ml = (e) => ((e %= 360), e < 0 && (e += 360), e)),
      (hl = fl),
      (gl = (e) => Math.sqrt(e[0] * e[0] + e[1] * e[1])),
      (_l = (e) => Math.sqrt(e[4] * e[4] + e[5] * e[5])),
      (vl = {
        x: 12,
        y: 13,
        z: 14,
        ...
        scaleY: _l,
        scale: (e) => (gl(e) + _l(e)) / 2,
        rotateX: (e) => ml(dl(Math.atan2(e[6], e[5]))),
        rotateY: (e) => ml(dl(Math.atan2(-e[2], e[0]))),
        rotateZ: hl,
        rotate: hl,
        skewX: (e) => dl(Math.atan(e[4])),
        skewY: (e) => dl(Math.atan(e[1])),
      ...
      (Al = class {
        ...
        scheduleResolve() {
          ((this.state = `scheduled`),
            this.isAsync
              ? (El.add(this), Dl || ((Dl = !0), B.read(Pt), B.resolveKeyframes(Nt)))
      ...
      (jl = (e) => e.startsWith(`--`)),
      (Ml = {}),
      (Nl = Lt(() => c.ScrollTimeline !== void 0, `scrollTimeline`)),
      (Pl = Lt(() => c.ViewTimeline !== void 0, `viewTimeline`)),
      (Fl = Lt(() => {
        try {
      ...
      (zl = { anticipate: Zs, backInOut: Xs, circInOut: ec }),
      (Bl = 10),
      (Vl = class extends Rl {
        constructor(e) {
          (Ut(e),
      ...
      (Gl = Pe(() => Object.hasOwnProperty.call(Element.prototype, `animate`))),
      (Kl = (e, t) =>
        t === `zIndex`
          ? !1
          : !!(
      ...
      (ru = (e, { keyframes: t }) =>
        t.length > 2 ? tu : xl.has(e) ? (e.startsWith(`scale`) ? eu(t[1]) : $l) : nu),
      (iu = new Set([
        `when`,
        `delay`,
        `delayChildren`,
      ...
      (au =
        ...
        (o) => {
          ...
          return s.isSync ? new ul(u) : new Jl(u);
        }),
      (ou = new Set([`width`, `height`, `top`, `left`, `right`, `bottom`, ...bl])),
      (su = 30),
      ...
      (uu = class {
        ...
        setCurrent(e) {
          ((this.current = e),
            ...
            this.canTrackVelocity === null &&
              e !== void 0 &&
              (this.canTrackVelocity = cu(this.current)));
        }
        ...
        getVelocity() {
          let e = U.now();
          if (!this.canTrackVelocity || this.prevFrameValue === void 0 || e - this.updatedAt > su)
            return 0;
          let t = Math.min(this.updatedAt - this.prevUpdatedAt, su);
      ...
      (du = (e) => Array.isArray(e)),
      (X = (e) => !!(e && e.getVelocity)),
      (fu = `framerAppearId`),
      (pu = `data-` + dn(fu)),
      (mu = (e) => (t) => t.test(e)),
      (hu = [yc, G, W, Mc, Pc, Nc, { test: (e) => e === `auto`, parse: (e) => e }]),
      (gu = (e) => hu.find(mu(e))),
      (_u = {
        rotate: Mc,
        rotateX: Mc,
      ...
      (bu = new Set([`brightness`, `contrast`, `saturate`, `opacity`])),
      (xu = /\b([a-z-]*)\(.*?\)/gu),
      (Su = {
        ...q,
        getAnimatableNone: (e) => {
      ...
      (Ou = class extends Al {
        ...
        readKeyframes() {
          ...
          if ((this.resolveNoneKeyframes(), !ou.has(n) || e.length !== 2)) return;
          let [r, i] = e,
            a = gu(r),
            o = gu(i);
          if (He(r) !== He(i) && Tl[n]) {
        ...
        measureInitialState() {
          ...
          (n === `height` && (this.suspendedScrollY = c.pageYOffset),
            (this.measuredOrigin = Tl[n](e.measureViewportBox(), c.getComputedStyle(e.current))),
        ...
        measureEndState() {
          ...
          let i = n.length - 1,
            a = n[i];
          ((n[i] = Tl[t](e.measureViewportBox(), c.getComputedStyle(e.current))),
      ...
      (Z = { x: !1, y: !1 }),
      (Mu = (e, t) => (t ? (e === t ? !0 : Mu(e, t.parentElement)) : !1)),
      (Nu = (e) =>
        e.pointerType === `mouse`
      ...
      (ad = class {
          ...
          ((this.current = e),
            ...
            this.reducedMotionConfig === `never`
              ...
              : this.reducedMotionConfig === `always`
                ...
                : (td.current || ir(), (this.shouldReduceMotion = ed.current)),
        ...
        bindToMotionValue(e, t) {
          ...
          let r = t.on(`change`, (t) => {
            ...
            i;
          (c !== void 0 && c.MotionCheckAppearSync && (i = c.MotionCheckAppearSync(this, e, t)),
            this.valueSubscriptions.set(e, () => {
        ...
        readValue(e, t) {
          ...
          return (
            n != null &&
              (typeof n == `string` && (Is(n) || Ls(n))
                ? (n = parseFloat(n))
                : !qu(n) && q.test(t) && (n = yn(e, t)),
      ...
      (hd = class extends od {
        ...
        readValueFromInstance(e, t) {
          if (xl.has(t)) return this.projection?.isProjecting ? kt(t) : yl(e, t);
          {
            let n = Mr(e),
      ...
      (Sd = class extends od {
        ...
        readValueFromInstance(e, t) {
          ...
          return ((t = bd.has(t) ? t : dn(t)), e.getAttribute(t));
        }
        scrapeMotionValuesFromProps(e, t, n) {
          return Lr(e, t, n);
        }
      ...
      (Yd = (e) => s !== void 0 && s.userAgent && s.userAgent.toLowerCase().includes(e)),
      (Xd = Yd(`applewebkit/`) && !Yd(`chrome/`) ? Math.round : I),
      (Zd = Si({
      ...
      (ef = Si({
        ...
        defaultParent: () => {
          if (!$d.current) {
            let e = new Zd({});
            (e.mount(c), e.setOptions({ layoutScroll: !0 }), ($d.current = e));
          }
          return $d.current;
        },
        resetTransform: (e, t) => {
      ...
      (nf = ({
        ...
        return (
          ...
          m(Ps.Provider, { value: p, children: e })
        );
      }),
      (rf = (e) => e.key || ``),
      (af = ({
        ...
        if (g !== w) {
          ...
          return (o === `wait` && E.length && (e = E), te($i(e)), ee(g), null);
        }
        let { forceRender: ne } = d(js);
        return m(S, {
          children: T.map((e) => {
            let a = rf(e),
              u = s && !p ? !1 : g === T || _.includes(a);
            return m(
              nf,
              {
                isPresent: u,
                ...
                onExitComplete: u
                  ? void 0
                  : () => {
                      if (C.current.has(a)) return;
                      if (x.has(a)) (C.current.add(a), x.set(a, !0));
                      else return;
                      let e = !0;
                      (x.forEach((t) => {
                        t || (e = !1);
                      }),
                        e && (ne?.(), te(b.current), s && h?.(), r && r()));
                    },
                anchorX: c,
                anchorY: l,
                children: e,
      ...
      (sf = (e) => e === !0),
      (cf = (e) => sf(e === !0) || e === `id`),
      (lf = ({ children: e, id: t, inherit: n = !0 }) => {
        let r = d(js),
          i = d(of),
          [o, s] = ta(),
          c = a(null),
        ...
        c.current === null &&
          (cf(n) && l && (t = t ? l + `-` + t : l),
          (c.current = { id: t, group: (sf(n) && r.group) || Ki() }));
        let u = y(() => ({ ...c.current, forceRender: o }), [s]);
        return m(js.Provider, { value: u, children: e });
      }),
      (uf = f({ strict: !1 })),
      (df = {
        animation: [
    ...
    ((hf = f({})),
      ...
      (kf = (e, t) => Math.abs(e - t)),
      (Af = (e, t) => ((t.isSVG ?? ya(e)) ? new Sd(t) : new hd(t, { allowProjection: e !== l }))),
      ...
      (Nf = class {
        ...
        startScrollTracking(e) {
          ...
          (this.scrollPositions.set(c, { x: c.scrollX, y: c.scrollY }),
            c.addEventListener(`scroll`, this.onElementScroll, { capture: !0 }),
            c.addEventListener(`scroll`, this.onWindowScroll),
            (this.removeScrollListeners = () => {
              (c.removeEventListener(`scroll`, this.onElementScroll, { capture: !0 }),
                c.removeEventListener(`scroll`, this.onWindowScroll));
            }));
        }
        handleScroll(e) {
          ...
          if (!t) return;
          let n = e === c,
            r = n ? { x: c.scrollX, y: c.scrollY } : { x: e.scrollLeft, y: e.scrollTop },
      ...
      (If = class {
        ...
        startAxisValueAnimation(e, t) {
          ...
          return (un(this.visualElement, e), n.start(au(e, n, 0, t, this.visualElement, !1)));
        }
        stopAnimation() {
        ...
        addListeners() {
          ...
          let o = _i(c, `resize`, () => this.scalePositionWithinConstraints()),
      ...
      (pp = new WeakMap()),
      (mp = new WeakMap()),
      (hp = (e) => (e === document.scrollingElement ? c : e)),
      (gp = [
        [cp.Enter, `entry`],
        [cp.Exit, `exit`],
        [cp.Any, `cover`],
      ...
      (_p = { start: 0, end: 1 }),
      (vp = new Map()),
      (yp = () => ({ scrollX: D(0), scrollY: D(0), scrollXProgress: D(0), scrollYProgress: D(0) })),
      (bp = (e) => (e ? !e.current : !1)),
      (xp = class extends uu {
        constructor() {
        ...
        add(e) {
          (xl.has(e) || Hl.has(e)) && ((this.isEnabled = !0), this.update());
        }
        update() {
...
//# sourceMappingURL=motion.DYJBFqJ8.mjs.map

...
import { S as u, t as d } from "./motion.DYJBFqJ8.mjs";
import { C as f, H as p, a as m, v as h } from "./framer.S4LHNcVj.mjs";
var g,
  _,
  v,
  y = e(() => {
...
var S,
  ...
  w = e(() => {
    (t(),
      ...
      (C = (e, t) => e.find((e) => e.toLowerCase().includes(t))));
  }),
  T,
  E,
  D = e(() => {
...
function k(e) {
  let {
    ...
    b = n(!1),
    S = x(A, o, c, l, N),
    [C, w] = r(S === `Home` ? E(i) : null);
  async function T() {
    try {
      let e = await import(`${j}${S}.js@0.0.53`);
      b.current && w(e.default(i));
    } catch {
      b.current && w(null);
    }
  }
  ...
  let D = h.current() === h.canvas ? a(v, {}) : null;
  return a(u.div, {
...
var A,
  ...
  P = e(() => {
    (l(),
      ...
      (j = `https://framer.com/m/phosphor-icons/`),
      (M = [`thin`, `light`, `regular`, `bold`, `fill`, `duotone`]),
      (N = A.reduce((e, t) => ((e[t.toLowerCase()] = t), e), {})),
      (k.displayName = `Phosphor`),
      (k.defaultProps = {
        width: 24,
        height: 24,
        iconSelection: `House`,
      ...
      f(k, {
        ...
        color: { type: m.Color, title: `Color`, defaultValue: k.defaultProps.color },
        weight: {
          type: m.Enum,
          title: `Weight`,
          optionTitles: M.map((e) => e.charAt(0).toUpperCase() + e.slice(1)),
          options: M,
          defaultValue: k.defaultProps.weight,
        },
        mirrored: {
          type: m.Boolean,
          enabledTitle: `Yes`,
          disabledTitle: `No`,
          defaultValue: k.defaultProps.mirrored,
        },
        ...S,
      }));
  });
export { x as a, w as i, P as n, b as o, S as r, v as s, k as t };
//# sourceMappingURL=Phosphor.DGAz4AAu.mjs.map
